...
var resumeData = {
  jobs: [{
    ...
    orgImageUrl: require('../img/logo_twitter.png'),
    ...
    orgImageUrl: require('../img/logo_microsoft.png'),
    ...
    orgImageUrl: require('../img/logo_mozilla.png'),
    ...
    orgImageUrl: require('../img/logo_wish.png'),
    ...
    orgImageUrl: require('../img/logo_facebook.png'),
    ...
    orgImageUrl: require('../img/logo_uwaterloo.png'),
    ...
    orgImageUrl: require('../img/logo_xtremelabs.png'),
  ...
  projects: [{
    ...
    imageUrl: require('../img/thumbnail_photomap.png'),
    descriptions: [
    ...
    imageUrl: require('../img/thumbnail_uwflow.jpg'),
    descriptions: [
    ...
    imageUrl: require('../img/thumbnail_github.jpg'),
    descriptions: [
    ...
    imageUrl: require('../img/thumbnail_numbersapi.jpg'),
    descriptions: [
